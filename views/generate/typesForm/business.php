...
<div class="containerItem">
    ...
    <div class="hour">
        ...
        <select name="openingHoursMonday" id="">
            <option value="00">00 hs</option>
            <option value="01">01 hs</option>
            <option value="02">02 hs</option>
            <option value="03">03 hs</option>
            <option value="04">04 hs</option>
            <option value="05">05 hs</option>
            <option value="06">06 hs</option>
            <option value="07">07 hs</option>
            <option value="08">08 hs</option>
        ...
        <select name="closesHoursMonday" id="">
            <option value="00">00 hs</option>
            <option value="01">01 hs</option>
            <option value="02">02 hs</option>
            <option value="03">03 hs</option>
    ...
    <div class="hour">
        ...
        <select name="openingHoursTuesday" id="">
            <option value="00">00 hs</option>
            <option value="01">01 hs</option>
            <option value="02">02 hs</option>
            <option value="03">03 hs</option>
        ...
        <select name="closesHoursTuesday" id="">
            <option value="00">00 hs</option>
            <option value="01">01 hs</option>
            <option value="02">02 hs</option>
            <option value="03">03 hs</option>
    ...
    <div class="hour">
        ...
        <select name="openingHoursWednesday" id="">
            <option value="00">00 hs</option>
            <option value="01">01 hs</option>
            <option value="02">02 hs</option>
            <option value="03">03 hs</option>
        ...
        <select name="closesHoursWednesday" id="">
            <option value="00">00 hs</option>
            <option value="01">01 hs</option>
            <option value="02">02 hs</option>
            <option value="03">03 hs</option>
    ...
    <div class="hour">
        ...
        <select name="openingHoursThursday" id="">
            <option value="00">00 hs</option>
            <option value="01">01 hs</option>
            <option value="02">02 hs</option>
            <option value="03">03 hs</option>
        ...
        <select name="closesHoursThursday" id="">
            <option value="00">00 hs</option>
            <option value="01">01 hs</option>
            <option value="02">02 hs</option>
            <option value="03">03 hs</option>
    ...
    <div class="hour">
        ...
        <select name="openingHoursFriday" id="">
            <option value="00">00 hs</option>
            <option value="01">01 hs</option>
            <option value="02">02 hs</option>
            <option value="03">03 hs</option>
        ...
        <select name="closesHoursFriday" id="">
            <option value="00">00 hs</option>
            <option value="01">01 hs</option>
            <option value="02">02 hs</option>
            <option value="03">03 hs</option>
    ...
    <div class="hour">
        <input type="checkbox" name="checkSaturday">
        <label class="label" for="saturday">Sabado</label>
        <select name="openingHoursSaturday" id="">
            <option value="00">00 hs</option>
            <option value="01">01 hs</option>
            <option value="02">02 hs</option>
            <option value="03">03 hs</option>
        ...
        <select name="closesHoursSaturday" id="">
            <option value="00">00 hs</option>
            <option value="01">01 hs</option>
            <option value="02">02 hs</option>
            <option value="03">03 hs</option>
    ...
    <div class="hour">
        <input type="checkbox" name="checkSunday">
        <label class="label" for="sunday">Domingo</label>
        <select name="openingHoursSunday" id="">
            <option value="00">00 hs</option>
            <option value="01">01 hs</option>
            <option value="02">02 hs</option>
            <option value="03">03 hs</option>
        ...
        <select name="closesHoursSunday" id="">
            <option value="00">00 hs</option>
            <option value="01">01 hs</option>
            <option value="02">02 hs</option>
            <option value="03">03 hs</option>
...
<div class="containerItem">
    ...
    <div id="containerButtons">
        ...
        <input type="checkbox" id="wifi" name="wifi" hidden/>
        <button class="item"  data-info="seat">
        ...
        <input type="checkbox" id="seat" name="seat" hidden/>
        <button class="item" data-info="accessible">
        ...
        <input type="checkbox" id="accessible" name="accessible" hidden/>
        <button class="item" data-info="toilet">
        ...
        <input type="checkbox" id="toilet" name="toilet" hidden/>
        <button class="item" data-info="child">
        ...
        <input type="checkbox" id="child" name="child" hidden/>
        <button class="item" data-info="pet">
        ...
        <input type="checkbox" id="pet" name="pet" hidden/>
        <button class="item" data-info="parking">
        ...
        <button class="item" data-info="train">
        ...
        <input type="checkbox" id="train" name="train" hidden/>
        <button class="item" data-info="taxi">
        ...
        <input type="checkbox" id="taxi" name="taxi" hidden/>
        <button class="item" data-info="bed">
        ...
        <input type="checkbox" id="bed" name="bed" hidden/>
        <button class="item" data-info="cafe">
        ...
        <input type="checkbox" id="cafe" name="cafe" hidden/>
        <button class="item" data-info="bar">
        ...
        <input type="checkbox" id="bar" name="bar" hidden/>
        <button class="item" data-info="restaurant">
        ...
        <input type="checkbox" id="restaurant" name="restaurant" hidden/>
    </div>
</div>
<div class="containerItem">
