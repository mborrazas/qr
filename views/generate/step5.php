...
<section id="containerData">
    ...
    <div class="containerItem">
        ...
        <h3 class="title">¡Finaliza tu pago para tu qr!</h3>
    </div>
    <div class="containerItem" >
        <p class="totalToPay">Total a pagar</p>
        <p class="price">0,50 €</p>
        <p class="descriptionPlan">Test Plan</p>
        <button id="checkout-button" class="buttonToPay">Pagar</button>
    </div>
</section>
<script>
