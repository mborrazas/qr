...
<?php } ?>
<?php if(!is_null($data->getPeopleName()) || !is_null($data->getSurname())): ?>
    <p id="name"> <?php echo $data->getPeopleName(); echo " ".$data->getSurname(); ?></p>
<?php endif ?>
<?php  if(!is_null($data->getProfession())): ?>
    <p id="profession"><?php echo $data->getProfession(); ?></p>
<?php endif; ?>
<section id="containerInfo">
    <?php if(!is_null($data->getSummary())): ?>
        <p id="summary"><?php echo $data->getSummary(); ?></p>
    <?php endif; ?>
    <?php if(!is_null($data->getPhone())): ?>
        <div class="item" id="phone">
            ...
            <div class="text">
                <p class="value"><?php echo $data->getPhone(); ?></p>
    ...
    <?php endif; ?>
    <?php if(!is_null($data->getPersonalWebsite())): ?>
        <div class="item">
            <div class="icon">
            ...
            <div class="text">
                <p class="value"><?php echo $data->getPersonalWebsite(); ?></p>
    ...
    <?php endif; ?>
    <?php if(!is_null($data->getCompany()) || !is_null($data->getProfession())): ?>
        <div class="item">
            <div class="icon">
            ...
            <div class="text">
                <p class="value"><?php echo $data->getProfession(); ?></p>
                <p class="gray"><?php echo $data->getCompany(); ?></p>
            </div>
        </div>
    <?php endif; ?>
